...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="inventory-stock_issuance.php" class="current">Stock Issuance</a> </div>
...
<div>
              <a href="inventory-stock_issuance_info.php"><button class="btn btn-primary"><i class="icon-plus"></i> Create</button></a>
              <a href="inventory-stock_issuance_info.php"><button class="btn btn-info"><i class="icon-pencil"></i> Update</button></a>
              <button class="btn btn-danger"><i class="icon-remove"></i> Cancel</button>
              <button class="btn btn-success"><i class="icon-print"></i> Print</button>
</div>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Stock issuance List</h5>
          </div>
