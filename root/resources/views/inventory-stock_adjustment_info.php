...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href="inventory-stock_adjustment.php" class="tip-bottom">Stock Adjustment</a><a href="inventory-stock_adjustment_info.php" class="current">Stock Adjustment Entry</a> </div>
    <h1>Stock Adjustment Entry</h1> 
    <div class="user-menu">
    </div>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>Stock Adjustment Information</h5>
          </div>
              ...
              <div class="span12 nopadding">
                  ...
                  <div class="col-lg-12">
                              ...
                              <div class="control-group col-lg-2">
                                ...
                                <div class="controls">
                                  <input type="text" value="" class="span12" style="background-color:#034e79" placeholder="0.00" disabled>
                                </div>
                              </div>
                  </div>
