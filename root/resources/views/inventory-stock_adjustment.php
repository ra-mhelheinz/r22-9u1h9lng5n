...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="inventory-stock_adjustment.php" class="current">Stock Adjustment</a> </div>
...
<div>
              <a href="inventory-stock_adjustment_info.php"> <button class="btn btn-primary"><i class="icon-plus"></i> Create</button></a>
              <a href="inventory-stock_adjustment_info.php"><button class="btn btn-info"><i class="icon-pencil"></i> Update</button></a>
