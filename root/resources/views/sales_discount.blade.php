<style type="text/css">
      ...
      <div class="popup" pd-popup="sales_discount">
              <div class="popup-inner-lg">
                  <div class="modal-header">
                  Discount
                  <a class="popup-close" pd-popup-close="sales_discount" href="#"> </a>
                  
                  </div>
                        <div class="modal-body" style="overflow-y:auto;" >
                          <div class="row-fluid">

              <button class="btn btn-primary" pd-popup-open="sales_discount_info" href="#"><i class="icon-plus"></i> Add New</button>
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <div class="modal-footer">
                    ...
                    <a pd-popup-close="sales_discount" href="#" class="btn btn-danger m_close">Close</a>
                  </div>
