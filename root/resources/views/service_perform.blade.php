      ...
      <div class="popup" pd-popup="service_perform">
              <div class="popup-inner-lg">
                  <div class="modal-header">
                  Service Perform
                  <a class="popup-close" pd-popup-close="service_perform" href="#"> </a>
                  
                  </div>
                        <div class="modal-body" style="overflow-y:auto;" >
                          <div class="row-fluid">

              <button class="btn btn-primary" pd-popup-open="service_perform_info" href="#"><i class="icon-plus"></i> Add New</button>
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <div class="modal-footer">
                    ...
                    <a pd-popup-close="service_perform" href="#" class="btn btn-danger m_close">Close</a>
                  </div>
