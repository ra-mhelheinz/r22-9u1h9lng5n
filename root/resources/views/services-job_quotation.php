...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="services-job_quotation.php" class="current">Job Quotaion</a> </div>
    <h1>Job Quotaion</h1> 
    <div class="user-menu">
    </div>
  </div>
...
<div>
              <a href="services-job_quotation_info.php"><button class="btn btn-primary"><i class="icon-plus"></i> Create</button></a>
              <a href="services-job_quotation_info.php"><button class="btn btn-info"><i class="icon-pencil"></i> Update</button></a>
