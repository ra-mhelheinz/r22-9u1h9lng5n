      ...
      <div class="popup" pd-popup="service_vehicle">
              <div class="popup-inner-lg">
                  <div class="modal-header">
                  Vehicle
                  <a class="popup-close" pd-popup-close="service_vehicle" href="#"> </a>
                  
                  </div>
                        <div class="modal-body" >
                          <div class="row-fluid">

              <button class="btn btn-primary" pd-popup-open="service_vehicle_info" href="#"><i class="icon-plus"></i> Add New</button>
              ...
              <tbody>
                <tr class="gradeX">
                  ...
                  <div class="modal-footer">
                    ...
                    <a pd-popup-close="service_vehicle" href="#" class="btn btn-danger m_close">Close</a>
                  </div>
