      ...
      <div class="popup" pd-popup="service_brand">
              <div class="popup-inner-lg">
                  <div class="modal-header">
                  Brand
                  <a class="popup-close" pd-popup-close="service_brand" href="#"> </a>
                  
                  </div>
                        <div class="modal-body" style="overflow-y:auto;" >
                          <div class="row-fluid">

              <button class="btn btn-primary" pd-popup-open="service_brand_info" href="#"><i class="icon-plus"></i> Add New</button>
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <div class="modal-footer">
                    ...
                    <a pd-popup-close="service_brand" href="#" class="btn btn-danger m_close">Close</a>
                  </div>
