...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href="inventory-stock_transfer.php" class="tip-bottom">Stock Transfer</a><a href="inventory-stock_transfer_info.php" class="current">Stock Transfer Entry</a> </div>
    <h1>Stock Transfer Entry</h1> 
    <div class="user-menu">
    </div>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>Stock ITransfer Information</h5>
          </div>
