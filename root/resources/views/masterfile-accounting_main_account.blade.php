...
<div id="content">
  <div id="content-header">
    @php
      $_bc = ['<a href="#">Master File</a>', '<a href="#">Accounting</a>', '<a href="'.url('master-file/accounting/main-account').'" class="current">Main Account List</a>'];
    @endphp
            ...
            <table id="mtable" class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td>
                    <center>
                      <a href="#Update" pd-popup-open="small" class="btn btn-info" type="button" onclick="EditMode('{{$m01->mag_code}}', '{{$m01->mag_desc}}', '{{$m01->accttype_code}}');"><i class="icon-pencil"></i></a>
                      <a href="#" pd-popup-open="small" class="btn btn-danger" type="button" onclick="DeleteMode('{{$m01->mag_code}}', '{{$m01->mag_desc}}')"><i class="icon-remove"></i></a>
                    </center>
                  </td>
                </tr>
                @endforeach
  ...
  <div id="Add" class="popup" pd-popup="small">
    <div class="popup-inner" style="height: auto">
      <form id="AddForm" method="post" action="{{url('master-file/accounting/main-account')}}">
        {{ csrf_field() }}
        <div class="modal-header">
          Main Account List <span id="MOD_MODE"></span>
            ...
            <div class="col-lg-10"> 
              <span class="AddMode EditMode">
                <div class="control-group col-lg-12">
                  <div class="controls">
                    <label> Main Account ID <span style="color:red;font-weight: bolder">*</span></label>
                    <input type="text" name="txt_main_account_id" maxlength="3" style="text-transform: uppercase;" required>
                  </div>
                </div>
                <div class="control-group col-lg-12">
                  <div class="controls">
              ...
              <div class="DeleteMode control-group col-lg-12" style="display: none">
                <div class="controls">
                  <label for="">Are you sure you want to delete <span style="color:red;font-weight: bold" id="DeleteName"></span> from Main Account List ?</label>
                </div>
              </div>
            </div>
          </div>
...
<script>
  ...
  function emptyAdd(){
    ...
    $('input[name="txt_main_account_id"]').val('');
    $('input[name="txt_main_account_id"]').attr('required', '');
    $('input[name="txt_main_account_id"]').removeAttr('readonly');
  ...
  function EditMode(code, desc, typ){
    ...
    $('input[name="txt_name"]').attr('required', '');
    $('input[name="txt_main_account_id"]').val(code);
    $('input[name="txt_main_account_id"]').attr('required', '');
    $('input[name="txt_main_account_id"]').attr('readonly','');
  ...
  function DeleteMode(code, desc){
    ...
    $('input[name="txt_main_account_id"]').removeAttr('required', '');
