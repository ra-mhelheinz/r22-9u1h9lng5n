...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="inventory-Rstock_transfer.php" class="current">Receiving Stock Transfer</a> </div>
    <h1>Receiving Stock Transfer</h1> 
    <div class="user-menu">
    </div>
  </div>
          ...
          <div class="col-lg-12">
                      <div class="control-group col-lg-4">
                        ...
                        <div class="controls">
                          ...
                          <input type="text" value="" class="span7"  style="margin-top: 0px; margin-left:2px;">
                        </div>
                      </div>
...
<div>
              ...
              <a href="inventory-Rstock_transfer_info.php"><button class="btn btn-info"><i class="icon-pencil"></i> Update</button></a>
