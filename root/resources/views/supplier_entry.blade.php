      ...
      <div class="popup" pd-popup="supplier_entry">
              <div class="popup-inner">
                  <div class="modal-header">
                  Supplier Entry
                  <a class="popup-close" pd-popup-close="supplier_entry" href="#"> </a>
                          ...
                          <div class="row-fluid" style="overflow: hidden;">
                                        <div class="col-lg-12">
                                                  <div class="control-group col-lg-3">
                                                    <label class="control-label">Supplier I.D.</label>
                                                    <div class="controls">
                                        ...
                                        <div class="col-lg-12">
                                                  ...
                                                  <div class="control-group col-lg-5">
                                                    <label class="control-label">Subledger:</label>
                                                    <div class="controls">
                                                      <select class="span11">
                                                          <option>First option</option>
                                                          <option>Second option</option>
                  ...
                  <div class="modal-footer">
                    ...
                    <a pd-popup-close="supplier_entry" href="#" class="btn btn-danger m_close">Close</a>
                  </div>
