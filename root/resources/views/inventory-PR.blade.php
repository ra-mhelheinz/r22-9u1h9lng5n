...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="{{url('invetory-PR')}}" class="current">Purchase Request</a> </div>
...
<div>
              <a href="{{url('purshase_request_info')}}"><button class="btn btn-primary"><i class="icon-plus"></i> Create</button></a>
              <a href="purshase_request_info.php"><button class="btn btn-info"><i class="icon-pencil"></i> Update</button></a>
