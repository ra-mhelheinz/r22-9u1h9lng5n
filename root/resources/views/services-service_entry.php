...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="services-service_entry.php" class="current">Service Entry</a> </div>
    <h1>Service Entry</h1> 
    <div class="user-menu">
    </div>
  </div>
...
<div>
              <a href="#"><button pd-popup-open="authorize-appointment" class="btn btn-primary"><i class="icon-plus"></i> Appointment</button>
              <a href="services-service_entry_info.php"><button class="btn btn-primary"><i class="icon-plus"></i> Walk In/Others</button>
              <a href="services-service_entry_info.php"><button class="btn btn-info"><i class="icon-pencil"></i> Update Transaction</button></a>
