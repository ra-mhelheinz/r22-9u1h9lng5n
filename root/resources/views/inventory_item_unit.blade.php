      ...
      <div class="popup" pd-popup="inventory_item_unit">
              <div class="popup-inner-lg">
                  <div class="modal-header">
                  Item Unit
                  <a class="popup-close" pd-popup-close="inventory_item_unit" href="#"> </a>
                  
                  </div>
                        <div class="modal-body" style="overflow-y:auto;" >
                          <div class="row-fluid">

              <button class="btn btn-primary" pd-popup-open="inventory_item_unit_info" href="#"><i class="icon-plus"></i> Add New</button>
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <div class="modal-footer">
                    ...
                    <a pd-popup-close="inventory_item_unit" href="#" class="btn btn-danger m_close">Close</a>
                  </div>
