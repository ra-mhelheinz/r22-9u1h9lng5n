...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="{{url('parts-cashier')}}" class="current">Parts Cashier</a> </div>
    <h1>Parts Cashier</h1> 
    <div class="user-menu">
    </div>
  </div>
