...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="CRM-calendar.php" class="current">Calendar</a> </div>
    <h1>Calendar</h1> 
    <div class="user-menu">
    </div>
  </div>
