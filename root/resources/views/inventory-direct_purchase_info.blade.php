...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href="{{url('inventory-direct_purchase')}}" class="tip-bottom">Direct Purchase</a><a href="{{url('inventory-direct_purchase_info')}}" class="current">Direct Purchase Entry</a> </div>
    <h1>Direct Purchase Entry</h1> 
    <div class="user-menu">
    </div>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>Direct Purchase Information</h5>
          </div>
          ...
          <div class="container-fluid">
              <div class="span12 nopadding">
                  ...
                  <div class="col-lg-12">
                              ...
                              <div class="drop1 control-group col-lg-6">
