...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="email-campaign.php" class="current">Email</a> </div>
    <h1>Email Blast Schedule</h1> 
    <div class="user-menu">
    </div>
  </div>
