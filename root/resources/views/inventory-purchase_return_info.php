...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href="inventory-purchase_return.php" class="tip-bottom">Purchase Returns</a><a href="inventory-purchase_return_info.php" class="current">Purchase Return Entry</a> </div>
              ...
              <div class="span12 nopadding">
                    <div class="col-lg-12">
                              <div class="control-group col-lg-2">
                                <label class="control-label">Return No.</label>
                                <div class="controls">
                  ...
                  <div class="col-lg-12">
                              ...
                              <div class="control-group col-lg-3 total">
                                ...
                                <div class="controls">
                                  <input type="text" value="" class="span9" style="background-color:#034e79" placeholder="0.00">
                                </div>
                              </div>
                  </div>
