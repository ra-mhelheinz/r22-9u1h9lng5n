...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Master File</a> <a href="masterfile-accounting_account_group.php" class="current">Collection</a> </div>
    <h1>Collection</h1> 
    <div class="user-menu">
    </div>
  </div>
