...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="masterfile-accounting_main_account.php" class="current">Main Account List</a> </div>
    <h1>Main Account</h1> 
    <div class="user-menu">
    </div>
  </div>
