...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="masterfile-accounting_account_group.php" class="current">Account Group List</a> </div>
    <h1>Account Group</h1> 
    <div class="user-menu">
    </div>
  </div>
