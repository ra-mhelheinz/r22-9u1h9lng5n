...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="services-service_cashier.php" class="current">Service Cashier</a> </div>
    <h1>Service Cashier</h1> 
    <div class="user-menu">
    </div>
  </div>
